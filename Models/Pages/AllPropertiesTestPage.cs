...
public class AllPropertiesTestPage : PageData
{
    ...
    [BackingType(typeof(OptiAlloyPersonListProperty))]
...
#pragma warning disable CS0618 // Type or member is obsolete
    ...
    [Display(Name = "Page Reference (Model type)", Description = Description, GroupName = "Content_Reference", Order = 32)]
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    [Display(Name = "Content Reference", Description = Description, GroupName = "Content_Reference", Order = 1)]
    public virtual ContentReference ContentReference1 { get; set; }

    [Display(Name = "Content Reference [Readonly]", Description = Description, GroupName = "Content_Reference", Order = 2)]
    [ReadOnly(true)]
    public virtual ContentReference ContentReferenceReadonly1 { get; set; }

    [Display(Name = "Page Reference (AllowedTypes)", Description = Description, GroupName = "Content_Reference", Order = 31)]
    [AllowedTypes(typeof(PageData))]
    public virtual ContentReference PageReference1 { get; set; }

    [Display(Name = "Content Reference (AllowedTypes `MediaData`)", Description = Description, GroupName = "Content_Reference", Order = 33)]
    [AllowedTypes(typeof(MediaData))]
    public virtual ContentReference MediaReference1 { get; set; }

    [Display(Name = "Content Reference (AllowedTypes `ImageData`)", Description = Description, GroupName = "Content_Reference", Order = 34)]
    [AllowedTypes(typeof(ImageData))]
    public virtual ContentReference MediaReference2 { get; set; }

    [Display(Name = "Content Reference (UIHint `Media`)", Description = Description, GroupName = "Content_Reference", Order = 35)]
    [UIHint(UIHint.MediaFile)]
    public virtual ContentReference MediaReference3 { get; set; }

    [Display(Name = "Content Reference (UIHint `Video`)", Description = Description, GroupName = "Content_Reference", Order = 36)]
    [UIHint(UIHint.Video)]
    public virtual ContentReference MediaReference4 { get; set; }

    [Display(Name = "Content Reference (UIHint `Folder`)", Description = Description, GroupName = "Content_Reference", Order = 36)]
    [UIHint(UIHint.AssetsFolder)]
    public virtual ContentReference FolderReference { get; set; }

    [Display(Name = "Content Reference (UIHint `Image`)", Description = Description, GroupName = "Content_Reference", Order = 37)]
    [UIHint(UIHint.Image)]
    public virtual ContentReference MediaReference5 { get; set; }

    [Display(Name = "Content Reference (AllowedTypes `ImageData & VideoData`)", Description = Description, GroupName = "Content_Reference", Order = 38)]
    [AllowedTypes(typeof(ImageData), typeof(VideoData))]
    public virtual ContentReference MediaReference6 { get; set; }

    [Display(Name = "Block Reference (AllowedTypes)", Description = Description, GroupName = "Content_Reference", Order = 40)]
    ...
    [Display(Name = "Block Reference (UIHint `Block`)", Description = Description, GroupName = "Content_Reference", Order = 41)]
    [UIHint(UIHint.Block)]
    public virtual ContentReference BlockReference2 { get; set; }

    [Display(Name = "Block Reference (AllowedTypes - 3 block types)", Description = Description, GroupName = "Content_Reference", Order = 42)]
    [AllowedTypes(typeof(EditorialBlock), typeof(TeaserBlock), typeof(JumbotronBlock))]
    public virtual ContentReference BlockReference3 { get; set; }

    [Display(Name = "Image", Description = Description, GroupName = "Content_Reference", Order = 230)]
    [UIHint(UIHint.Image)]
    public virtual ContentReference Image1 { get; set; }

    [Display(Name = "Image [Readonly]", Description = Description, GroupName = "Content_Reference", Order = 240)]
    [UIHint(UIHint.Image)]
    [ReadOnly(true)]
    ...
    [CultureSpecific]
    [Display(GroupName = "CultureSpecificList")]
    ...
    [CultureSpecific]
    [Display(GroupName = "CultureSpecificList")]
    public virtual IList<ContentReference> ListOfReferences { get; set; }

    [CultureSpecific]
    [Display(GroupName = "CultureSpecificList")]
    public virtual IList<LinkItem> ListOfLinkItems { get; set; }

    [CultureSpecific]
    [Display(GroupName = "CultureSpecificList")]
    public virtual IList<LinkItem> ListOfGuids { get; set; }

    [CultureSpecific]
    [Display(GroupName = "CultureSpecificList")]
    public virtual IList<Url> ListOfUrls { get; set; }

    #endregion

    [Display(GroupName = Tabs.CustomEditorDescriptors, Order = 500)]
    [ClientEditor(ClientEditingClass = "ClientResources/Scripts/Editors/custom-editor.js", IsJavascriptModule = true)]
    public virtual string CustomEditor { get; set; }

    /*
    [Display(GroupName = Tabs.CustomEditorDescriptors, Order = 510)]
    [ClientEditor(ClientEditingClass = "ClientResources/Scripts/Editors/minimal-editor.js", IsJavascriptModule = true)]
    public virtual string MinimalEditor { get; set; }

    [Display(GroupName = Tabs.CustomEditorDescriptors, Order = 520)]
    [ClientEditor(ClientEditingClass = "ClientResources/Scripts/Editors/editor-as-function.js", IsJavascriptModule = true)]
    public virtual string EditorAsFunction { get; set; }*/
    ...
    {
        public const string List = "List_of_T";
        public const string PropertyList = "PropertyList_Legacy";
        public const string CustomEditorDescriptors = "Custom_Editor_Descriptors";
    }
}
...
public class OptiAlloyPersonListProperty : PropertyList<Person>
{
    public OptiAlloyPersonListProperty()
    {
...
// https://world.optimizely.com/documentation/developer-guides/CMS/Content/Properties/built-in-property-types/Built-in-auto-suggestion-editor/
